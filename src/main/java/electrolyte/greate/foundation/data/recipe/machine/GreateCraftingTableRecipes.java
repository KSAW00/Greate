...
public class GreateCraftingTableRecipes {
    ...
    public static void register(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, MECHANICAL_MIXERS[0].getId(), MECHANICAL_MIXERS[0].asStack(), "PSP", "CMC", "wWh", 'P', new UnificationEntry(plate, AndesiteAlloy), 'S', SHAFTS[0].asStack(), 'C', new UnificationEntry(plate, WroughtIron), 'M', CASING.getIngredient(0), 'W', new UnificationEntry(whisk, AndesiteAlloy));
        VanillaRecipeHelper.addShapedRecipe(provider, MILLSTONES[0].getId(), MILLSTONES[0].asStack(), "CAC", "WHW", "wSh", 'A', COGWHEELS[0].asStack(), 'C', new UnificationEntry(plate, AndesiteAlloy), 'H', CASING.getIngredient(0), 'W', Ingredient.of(ItemTags.WOODEN_SLABS), 'S', SHAFTS[0].asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, FANS[0].getId(), FANS[0].asStack(), "ASA", "CMC", "wRh", 'S', SHAFTS[0], 'A', new UnificationEntry(plate, AndesiteAlloy), 'C', new UnificationEntry(plate, WroughtIron), 'M', CASING.getIngredient(0), 'R', new UnificationEntry(rotor, AndesiteAlloy));
