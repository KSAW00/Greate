...
public class GreateCraftingTableRecipes {
    ...
    public static void register(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, FANS[0].getId(), FANS[0].asStack(), "ASA", "CMC", "wRh", 'S', SHAFTS[0], 'A', new UnificationEntry(plate, AndesiteAlloy), 'C', new UnificationEntry(plate, WroughtIron), 'M', CASING.getIngredient(0), 'R', new UnificationEntry(rotor, WroughtIron));
