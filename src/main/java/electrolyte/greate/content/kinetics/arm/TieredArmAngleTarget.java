...
public class TieredArmAngleTarget {

	static final TieredArmAngleTarget NO_TARGET = new TieredArmAngleTarget();
	...
	private TieredArmAngleTarget() {
		lowerArmAngle = 135;
		upperArmAngle = 45;
		headAngle = 0;
	}

	public TieredArmAngleTarget(BlockPos armPos, Vec3 pointTarget, Direction clawFacing, boolean ceiling) {
